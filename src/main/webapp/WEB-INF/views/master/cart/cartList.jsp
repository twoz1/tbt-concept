			...
			<div class="user_list master_list">
				...
				<div>
					<select name="searchType" id="searchType" onchange="keywordClear()">
						<option value="search_all" ${entity.cri.searchType=='search_all' ? 'selected' : ''}>전체</option>
						<option value="search_userId" ${entity.cri.searchType=='search_userId' ? 'selected' : ''}>고객ID</option>
						<option value="search_prodId" ${entity.cri.searchType=='search_prodId' ? 'selected' : ''}>상품ID</option>
					</select>
