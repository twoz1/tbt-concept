	...
	<form action="productInsert" method="Post" enctype="multipart/form-data" id="productInsert">
		<table>
			...
			<tr>
				<th>상품설명</th>
				<td>
					<input type="text" name="product_detail" id="product_detail" required/>
				</td>
			</tr>
			...
			<tr>
				<th>상품이미지1</th>
				<td>
					<input type="file" name="product_img1f" id="product_img1f" required/>
				</td>
			</tr>
			...
			<tr>
				<th>상품이미지2</th>
				<td>
					<input type="file" name="product_img2f" id="product_img2f" required/>
				</td>
			</tr>
			...
			<tr>
				<th>상품이미지3</th>
				<td>
					<input type="file" name="product_img3f" id="product_img3f" required/>
				</td>
			</tr>
			...
			<tr>
				<th>상품이미지4</th>
				<td>
					<input type="file" name="product_img4f" id="product_img4f" required/>
				</td>
			</tr>
