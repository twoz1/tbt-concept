...
<body>
	<table>
			...
			<tr>
				<th>상품분류코드 : </th>
				<td>
					<c:if test="${requestScope.productDetail.code == 'S'}">SUNGLASS</c:if>
			...
			<tr>
				<th>상품설명 : </th>
				<td>${requestScope.productDetail.product_detail}</td>
			</tr>
		...
		<a href="productDetail?jCode=U&product_id=${requestScope.productDetail.product_id}">상품 수정</a>
</body>
</html>