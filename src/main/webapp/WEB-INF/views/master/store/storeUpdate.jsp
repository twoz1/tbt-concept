	...
	<div id="master_wrap">
		...
		<main id="master_main">
			<div class="store_insert master_save">
				<h2 class="master_title">지점 수정</h2>
				<form action="storeInsert" method="Post"
					...
					<table>
						<tr>
							...
							<td>
								<input type="text" name="store_id" id="store_id" value="${requestScope.storeDetail.store_id}" readonly />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="store_tel" id="store_tel" value="${requestScope.storeDetail.store_tel}" required />
						...
						<tr>
							...
							<td><input type="text" name="store_address" id="store_address" value="${requestScope.storeDetail.store_address}" required readonly/></td>
						</tr>
						
						<tr>
							<th>상세주소</th>
							<td><input type="text" name="store_address_detail" id="store_address_detail" value="${requestScope.storeDetail.store_address_detail}"/></td>
						</tr>
