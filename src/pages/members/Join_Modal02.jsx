                ...
                <div class="modal_2">
                    ...
                    <table className='modal_2_t'>
                        <tr>
                            <th>구분</th>
                            <th>수집항목</th>
                            <th class="third_column">이용목적</th>
                        </tr>
                        <tr>
                            <th>가입</th>
                            <td>이메일 아이디,성명,비밀번호</td>
                            <td class="third_column">회원가입 후 서비스 이용공지사항 전달</td>
                        </tr>
                        <tr>
                            <th>본인확인</th>
                            <td>성명,휴대폰번호,생년월일,중복가입확인</td>
                            <td class="third_column">본인인증,연령 확인,회원가입</td>
                        </tr>
                        <tr>
                            <th rowspan="2">서비스</th>
                            <td>이메일 아이디,성명</td>
                            <td class="third_column">리뷰내역</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>주문</th>
                            <td>주문자 정보,결제정보</td>
                            <td class="third_column">본인확인,주문 상품의 결제 및 환불</td>
                        </tr>
                    </table>
