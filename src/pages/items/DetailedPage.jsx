        ...
        <div className = "DetailedPage">
            ...
            <div className="section">
                <div className="main_photo">
                    <img src={require("../../images/sunglass2.jpg")} alt="Eva crystal violet tint 정면"/>


                    <div className="sub_photo">
                        <a href="#"><img src={require("../../images/sunglass2.jpg")} alt="Eva crystal violet tint 정면"/></a>
                        <a href="./detailed_page2.html"><img src={require("../../images/sunglass22.jpg")}
                                alt="Eva crystal violet tint 앞 대각선"/></a>
                        <a href="./datiled_page3.html"><img src={require("../../images/sunglass222.jpg")}
                                alt="Eva crystal violet tint 측면"/></a>
                        <a href="./detailed_page4.html"><img src={require("../../images/sunglass2222.jpg")}
            ...
            <div className="detail" id="detail">
                <img src={require("../../images/sunglass2.jpg")} alt="Eva crystal violet tint 정면"/>
                <img src={require("../../images/sunglass22.jpg")} alt="Eva crystal violet tint 앞 대각선"/>
                <img src={require("../../images/sunglass222.jpg")} alt="Eva crystal violet tint 측면"/>
                <img src={require("../../images/sunglass2222.jpg")} alt="Eva crystal violet tint 뒷 대각선"/>
            </div>
