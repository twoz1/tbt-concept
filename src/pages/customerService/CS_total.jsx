...
const mockFreqQues = [
    {
        id: 0,
        freqQuesCat: "[증빙서류 발급]",
        freqQuesTitle: "현금영수증 발행은 어떻게 신청하나요?",
        contents: (<div>
    ...
    },
    {
        id: 2,
        freqQuesCat: "[포인트]",
        freqQuesTitle: "상품 구매 후 POINT는 언제 적립되나요?",
        contents: (<div>
    ...
    },
    {
        id: 4,
        freqQuesCat: "[교환/반품]",
        freqQuesTitle: "교환/반품 불가한 이유가 뭔가요?",
        contents: (<div>
    ...
    },
    {
        id: 5,
        freqQuesCat: "[상품평]",
        freqQuesTitle: "리뷰 작성으로 적립되는 POINT는 어떻게 되나요?",
        contents: (<div>
    ...
    },
    {
        id: 6,
        freqQuesCat: "[상품평]",
        freqQuesTitle: "베스트 & 프리미엄 리뷰 POINT는 어떻게 되나요?",
        contents: (<div>
    ...
    },
    {
        id: 7,
        freqQuesCat: "[배송]",
        freqQuesTitle: "여러 개 상품을 주문했는데 배송 택배비가 상품마다 발생되나요?",
        contents: (<div>
    ...
    },
    {
        id: 8,
        freqQuesCat: "[교환/반품]",
        freqQuesTitle: "교환 접수 시, 동일한 사이즈로 접수가 된 것 같은데 확인이 안되나요",
        contents: (<div>
    ...
    },
    {
        id: 9,
        freqQuesCat: "[교환/반품]",
        freqQuesTitle: "상품을 반송할 때 주의사항은 무엇인가요?",
        contents: (<div>
