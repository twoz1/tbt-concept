    ...
    return (
        <div>
            <section id="freq_ask_id" className="freq_ask">
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues02')}>
                            <strong>&#91;취소&#93;</strong>
                            주문을 취소하고 싶어요&#46;
                        </button>
                        {isModal('freqQues02') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues03')}>
                            <strong>&#91;포인트&#93;</strong>
                            상품 구매 후 POINT는 언제 적립되나요&#63;
                        </button>
                        {isModal('freqQues03') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues04')}>
                            <strong>&#91;배송&#93;</strong>
                            배송지가 검색되지 않아요&#46;
                        </button>
                        {isModal('freqQues04') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues05')}>
                            <strong>&#91;교환&#47;반품&#93;</strong>
                            교환&#47;반품 불가한 이유가 뭔가요&#63;
                        </button>
                        {isModal('freqQues05') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues06')}>
                            <strong>&#91;상품평&#93;</strong>
                            리뷰 작성으로 적립되는 POINT는 어떻게 되나요&#63;
                        </button>
                        {isModal('freqQues06') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues07')}>
                            <strong>&#91;상품평&#93;</strong>
                            베스트 &#38; 프리미엄 리뷰 POINT는 어떻게 되나요&#63;
                        </button>
                        {isModal('freqQues07') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues08')}>
                            <strong>&#91;배송&#93;</strong>
                            여러 개 상품을 주문했는데 배송 택배비가 상품마다 발생되나요&#63;
                        </button>
                        {isModal('freqQues08') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
                ...
                <div>
                    <p>
                        <button onClick={() => openModal('freqQues10')}>
                            <strong>&#91;교환&#47;반품&#93;</strong>
                            상품을 반송할 때 주의사항은 무엇인가요&#63;
                        </button>
                        {isModal('freqQues10') && <div className="modal_cover">
                            <div className="pop_CS">
                                <div>
